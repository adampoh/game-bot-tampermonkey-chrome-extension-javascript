...
window.isRespawn = false;

//Cookie operation Function - getting cookie value, setting cookie value ---- Paul
...
var bot = window.bot = (function (window) {
    return {
        ...
        changeHeadingAbs: function (angle) {
            ...
            //Slave must Follow Master ----Paul
            /*var bSet = false;
            if(bot.isMasterMode == true){
                bSet = true;
            }
            if(bot.isMasterMode == false){
                if ((window.getCookie('isMasterSnake') == 'false') || (window.getCookie('isMasterSnake') == '')){
                    bSet = true;
                }
                if (window.getCookie('isMasterSnake') == 'true'){
                    bSet = false;
                }
            }
            if (bSet == true){*/
            ...
            if (bSet == false){
                window.goalCoordinates = {
                    x: eval(window.getCookie('masterXX')),
                    y: eval(window.getCookie('masterXX'))
                };
            }*/
            //console.log('+++++++++++++++++');
            // ----Paul
        ...
        changeHeadingRel: function (angle) {
            ...
            //console.log(window.goalCoordinates.x);
            // ----Paul
            canvas.setMouseCoordinates(canvas.mapToMouse(window.goalCoordinates));
        },
        ...
        getCollisionPoints: function () {
            ...
            bot.collisionPoints = [];
            bot.collisionAngles = [];
            // Update Cookie Value ----Paul
            if ((bot.isMasterMode == true) && (window.snake.id > 0)){
                window.setCookie('isMasterSnake', true);
                window.setCookie('masterXX', Math.round(window.snake.xx));
                window.setCookie('masterYY', Math.round(window.snake.yy));
                window.setCookie('masterID', window.snake.id);
                window.setCookie('serverIP', window.force_ip);
                window.setCookie('serverPort', window.force_port);
            }
            if (window.snake.id < 0){
                if (bot.isMasterMode == true){
                    window.setCookie('isMasterSnake', false);
                    window.setCookie('masterXX', "");
                    window.setCookie('masterYY', "");
                    window.setCookie('masterID', "");
                    window.setCookie('serverIP', 'undefined');
                    window.setCookie('serverPort', 'undefined');
                }
            }
            //----Paul
        ...
        followCircleSelf: function () {
            ...
            if (bot.isMasterMode == false){
                if ((window.getCookie('isMasterSnake') == 'false') || (window.getCookie('isMasterMode') == '')){
                    bFlagSet = true;
                }
                if (window.getCookie('isMasterSnake') == 'true'){
                    bFlagSet = false;
...
var userInterface = window.userInterface = (function (window, document) {
    ...
    return {
        ...
        initServerIp: function () {
            ...
            var serverIn = document.createElement('select');
            var slaveNumDiv = document.createElement('div');
            var slaveNumIn = document.createElement('input');

            var option1 = document.createElement('option');
            option1.value = "206.191.155.104:444";
            option1.text = "206.191.155.104:444";

            var option2 = document.createElement('option');
            option2.value = "199.21.79.248:444";
            option2.text = "199.21.79.248:444";

            var option3 = document.createElement('option');
            option3.value = "206.191.154.40:444";
            option3.text = "206.191.154.40:444";

            var option4 = document.createElement('option');
            option4.value = "5.9.19.112:444";
            option4.text = "5.9.19.112:444";

            var option5 = document.createElement('option');
            option5.value = "176.9.63.208:444";
            option5.text = "176.9.63.208:444";

            var option6 = document.createElement('option');
            option6.value = "176.9.47.136:444";
            option6.text = "176.9.47.136:444";

            var option7 = document.createElement('option');
            option7.value = "176.9.107.136:444";
            option7.text = "176.9.107.136:444";

            var option8 = document.createElement('option');
            option8.value = "176.9.136.177:444";
            option8.text = "176.9.136.177:444";

            var option9 = document.createElement('option');
            option9.value = "176.9.137.138:444";
            option9.text = "176.9.137.138:444";

            var option10 = document.createElement('option');
            option10.value = "149.202.217.64:444";
            option10.text = "149.202.217.64:444";

            var option11 = document.createElement('option');
            option11.value = "149.202.210.80:444";
            option11.text = "149.202.210.80:444";

            var option12 = document.createElement('option');
            option12.value = "149.202.197.192:444";
            option12.text = "149.202.197.192:444";

            var option13 = document.createElement('option');
            option13.value = "149.202.217.65:444";
            option13.text = "149.202.217.65:444";

            var option14 = document.createElement('option');
            option14.value = "149.202.204.145:444";
            option14.text = "149.202.204.145:444";

            var option15 = document.createElement('option');
            option15.value = "149.202.216.25:444";
            option15.text = "149.202.216.25:444";

            var option16 = document.createElement('option');
            option16.value = "209.222.96.170:444";
            option16.text = "209.222.96.170:444";

            var option17 = document.createElement('option');
            option17.value = "172.93.105.194:444";
            option17.text = "172.93.105.194:444";

            var option18 = document.createElement('option');
            option18.value = "104.243.41.194:444";
            option18.text = "104.243.41.194:444";

            var option19 = document.createElement('option');
            option19.value = "149.56.20.72:444";
            option19.text = "149.56.20.72:444";

            var option20 = document.createElement('option');
            option20.value = "149.56.20.74:444";
            option20.text = "149.56.20.74:444";

            var option21 = document.createElement('option');
            option21.value = "149.56.20.139:444";
            option21.text = "149.56.20.139:444";

            var option22 = document.createElement('option');
            option22.value = "43.249.37.129:444";
            option22.text = "43.249.37.129:444";

            var option23 = document.createElement('option');
            option23.value = "43.249.37.201:444";
            option23.text = "43.249.37.201:444";

            var option24 = document.createElement('option');
            option24.value = "43.249.37.146:444";
            option24.text = "43.249.37.146:444";

            var option25 = document.createElement('option');
            option25.value = "43.249.36.234:444";
            option25.text = "43.249.36.234:444";

            var option26 = document.createElement('option');
            option26.value = "209.58.183.136:444";
            option26.text = "209.58.183.136:444";

            var option27 = document.createElement('option');
            option27.value = "103.254.153.160:444";
            option27.text = "103.254.153.160:444";

            var option28 = document.createElement('option');
            option28.value = "209.58.183.129:444";
            option28.text = "209.58.183.129:444";

            var option29 = document.createElement('option');
            option29.value = "209.58.183.193:444";
            option29.text = "209.58.183.193:444";

            var option30 = document.createElement('option');
            option30.value = "209.58.183.194:444";
            option30.text = "209.58.183.194:444";

            var option31 = document.createElement('option');
            option31.value = "209.58.183.130:444";
            option31.text = "209.58.183.130:444";

            var option32 = document.createElement('option');
            option32.value = "31.204.145.104:444";
            option32.text = "31.204.145.104:444";

            var option33 = document.createElement('option');
            option33.value = "31.204.145.97:444";
            option33.text = "31.204.145.97:444";

            var option34 = document.createElement('option');
            option34.value = "31.204.145.98:444";
            option34.text = "31.204.145.98:444";

            var option35 = document.createElement('option');
            option35.value = "31.204.145.99:444";
            option35.text = "31.204.145.99:444";

            var option36 = document.createElement('option');
            option36.value = "31.204.145.100:444";
            option36.text = "31.204.145.100:444";

            var option37 = document.createElement('option');
            option37.value = "31.204.145.101:444";
            option37.text = "31.204.145.101:444";

            var option38 = document.createElement('option');
            option38.value = "31.204.145.102:444";
            option38.text = "31.204.145.102:444";

            var option39 = document.createElement('option');
            option39.value = "185.50.104.152:444";
            option39.text = "185.50.104.152:444";

            var option40 = document.createElement('option');
            option40.value = "185.50.104.168:444";
            option40.text = "185.50.104.168:444";

            var option41 = document.createElement('option');
            option41.value = "185.50.104.177:444";
            option41.text = "185.50.104.177:444";

            var option42 = document.createElement('option');
            option42.value = "103.195.101.154:444";
            option42.text = "103.195.101.154:444";

            var option43 = document.createElement('option');
            option43.value = "103.195.101.114:444";
            option43.text = "103.195.101.114:444";

            var option44 = document.createElement('option');
            option44.value = "103.195.101.146:444";
            option44.text = "103.195.101.146:444";

            var option45 = document.createElement('option');
            option45.value = "221.121.144.249:444";
            option45.text = "221.121.144.249:444";

            var option46 = document.createElement('option');
            option46.value = "221.121.158.193:444";
            option46.text = "221.121.158.193:444";

            var option47 = document.createElement('option');
            option47.value = "221.121.158.41:444";
            option47.text = "221.121.158.41:444";
            ...
            serverIn.appendChild(option1);
            serverIn.appendChild(option2);
            serverIn.appendChild(option3);
            serverIn.appendChild(option4);
            serverIn.appendChild(option5);
            serverIn.appendChild(option6);
            serverIn.appendChild(option7);
            serverIn.appendChild(option8);
            serverIn.appendChild(option9);
            serverIn.appendChild(option10);
            serverIn.appendChild(option11);
            serverIn.appendChild(option12);
            serverIn.appendChild(option13);
            serverIn.appendChild(option14);
            serverIn.appendChild(option15);
            serverIn.appendChild(option16);
            serverIn.appendChild(option17);
            serverIn.appendChild(option18);
            serverIn.appendChild(option19);
            serverIn.appendChild(option20);
            serverIn.appendChild(option21);
            serverIn.appendChild(option22);
            serverIn.appendChild(option23);
            serverIn.appendChild(option24);
            serverIn.appendChild(option25);
            serverIn.appendChild(option26);
            serverIn.appendChild(option27);
            serverIn.appendChild(option28);
            serverIn.appendChild(option29);
            serverIn.appendChild(option30);
            serverIn.appendChild(option31);
            serverIn.appendChild(option32);
            serverIn.appendChild(option33);
            serverIn.appendChild(option34);
            serverIn.appendChild(option35);
            serverIn.appendChild(option36);
            serverIn.appendChild(option37);
            serverIn.appendChild(option38);
            serverIn.appendChild(option39);
            serverIn.appendChild(option40);
            serverIn.appendChild(option41);
            serverIn.appendChild(option42);
            serverIn.appendChild(option43);
            serverIn.appendChild(option44);
            serverIn.appendChild(option45);
            serverIn.appendChild(option46);
            serverIn.appendChild(option47);
            for(var i=0; i < 47; i++){
                serverIn.options[i].style.color = 'Black';
            }
            ...
            slaveNumDiv.style.width = '244px';
            slaveNumDiv.style.margin = '60px auto';
            slaveNumDiv.style.boxShadow = 'rgb(0, 0, 0) 0px 6px 50px';
            slaveNumDiv.style.opacity = 1;
            slaveNumDiv.style.background = 'rgb(76, 68, 124)';
            slaveNumDiv.className = 'taho';
            slaveNumDiv.style.display = 'block';

            slaveNumIn.className = 'sumsginp';
            slaveNumIn.placeholder = 'How many Slaves?';
            slaveNumIn.maxLength = 21;
            slaveNumIn.style.width = '220px';
            slaveNumIn.style.height = '24px';

            slaveNumDiv.appendChild(slaveNumIn);
            parent.appendChild(slaveNumDiv);

            userInterface.server = serverIn;
            userInterface.slaveNum = slaveNumIn;
        },
        ...
        playButtonClickListener: function () {
            ...
            userInterface.onPrefChange();
            var slaveN = eval(userInterface.slaveNum.value);
            console.log(slaveN);
            for (i = 0; i < slaveN; i++){
                window.open('http://slither.io/');
            }
            bot.isMasterMode = true;
            window.setCookie('isRespawn', true);
            window.isRespawn = true;
            //-When play Button Click , Set Cookie value ----Paul
            if (window.getCookie('isMasterSnake') == 'true'){
                window.force_ip = window.getCookie('serverIP');
                window.force_port = window.getCookie('serverPort');
                bot.connect();
            } else {
            ...
            if (window.getCookie('isMasterSnake') == ""){
                window.setCookie('isMasterSnake',false,365);
            }
            if (window.getCookie('masterXX') == ""){
                window.setCookie('masterXX',0,365);
            }
            if (window.getCookie('masterYY') == ""){
                window.setCookie('masterYY',0,365);
            }
            if (window.getCookie('masterID') == ""){
                window.setCookie('masterID',0,365);
            }

            if ((window.getCookie('isMasterSnake') == 'true') && ((eval(window.getCookie('masterID'))) > 0 )){
                bot.isMasterMode = false;
            }

            if ((window.getCookie('isMasterSnake') == 'false') && (bot.isMasterMode == true)){
                window.setCookie('isMasterSnake',bot.isMasterMode,365);
                window.setCookie('masterXX',window.snake.xx,365);
                window.setCookie('masterYY',window.snake.yy,365);
                window.setCookie('masterID',window.snake.id,365);
                window.setCookie('serverIP','undefined',365);
                window.setCookie('serverPort','undefined',365);
            }
        ...
        onkeydown: function (e) {
            ...
            if (window.playing) {
                ...
                //-- Letter `M` to toggle bot----Paul
                if (e.keyCode === 77) {
                    if(bot.isMasterMode == true){
                        bot.isMasterMode = !bot.isMasterMode;
                        window.setCookie('isMasterSnake',false,365);
                        window.setCookie('masterXX',0,365);
                        window.setCookie('masterYY',0,365);
                        window.setCookie('masterID',0,365);
                        ...
                        if (window.getCookie('isMasterSnake') == 'false'){
                            if (eval(window.getCookie('masterID')) <= 0){
                                bot.isMasterMode = !bot.isMasterMode;
                                window.setCookie('isMasterSnake',true,365);
                                window.setCookie('masterXX',window.snake.xx,365);
                                window.setCookie('masterYY',window.snake.yy,365);
                                window.setCookie('masterID',window.snake.id,365);
                                window.setCookie('serverIP',window.force_ip,365);
                                window.setCookie('serverPort',window.force_port,365);
                            }
                        }
                    }
                }
        ...
        onPrefChange: function () {
            ...
            oContent.push('[M]MasterMode: ' + ht(bot.isMasterMode));
        ...
        onFrameUpdate: function () {
            ...
            if (window.playing && window.snake !== null) {
                ...
                //--Show master position----Paul
                if ((bot.isMasterMode == false) && (window.getCookie('isMasterSnake') == 'true') && (eval(window.getCookie('masterID')) > 0)){
                    oContent.push('master x position: ' + Math.round(eval(window.getCookie('masterXX'))));
                    oContent.push('master y position: ' + Math.round(eval(window.getCookie('masterYY'))));
                    oContent.push('masterID: ' + window.getCookie('masterID'));
                }
                //----Paul
...
(function (window, document) {
    ...
    if ((window.getCookie('isRespawn') == 'true') && (window.isRespawn != true)){
        window.force_ip = window.getCookie('serverIP');
        window.force_port = eval(window.getCookie('serverPort'));
        window.dead_mtm = 0;
        window.login_fr = 0;
        bot.isBotRunning = false;
        window.forcing = true;
